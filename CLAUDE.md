...
Controle de roçadas e zeladoria nas unidades. SPA em Vite/React — atenção ao `base` do Vite e ao `basename` do React Router, que precisam bater com o subcaminho publicado. Tem homologação em `/teste`, publicada a partir da branch `develop`.

Publicado em `smedigital.com.br/rocada/` pelo GitHub Pages.
---
